...
public class Base64Util {
	 ...
	 * this method (in fact you probably should) if you're embedding this code
	 * into a larger program.
	 */
//	protected final static void main(String[] args) {
//		if (args.length < 3) {
...
//	} // end main
	...
	private final static void usage(String msg) {
		...
		System.err.println("Usage: java Base64Util -e|-d inputfile outputfile");
	} // end usage
	 ...
	 * 
	 * Example:
	 * <code>encodeObject( myObj, Base64Util.GZIP | Base64Util.DONT_BREAK_LINES )</code>
	 * 
	 * @param serializableObject
	 *            The object to encode
	 * @param options
	 ...
	 * 
	 * Example:
	 * <code>encodeBytes( myData, Base64Util.GZIP | Base64Util.DONT_BREAK_LINES )</code>
	 * 
	 * 
	 * @param source
	 *            The data to convert
	...
	public static boolean encodeToFile(byte[] dataToEncode, String filename) {
		...
		try {
			bos = new OutputStream(new FileOutputStream(filename), Base64Util.ENCODE);
	...
	public static boolean decodeToFile(String dataToDecode, String filename) {
		...
		OutputStream bos = null;
		try {
			bos = new OutputStream(new FileOutputStream(filename), Base64Util.DECODE);
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		public int read() throws IOException {
			...
			if (position < 0) {
				...
				// Else decoding
					...
					if (i == 4) {
						...
						throw new IOException("Improperly padded Base64Util input.");
					} // end
			...
			// Else error
				...
				throw new IOException("Error in Base64Util code reading stream.");
			} // end else
		} // end read
